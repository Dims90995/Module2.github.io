...
loginButton.style.width = '100%'; // Register button (redirects to Reg.html)
...
form.appendChild(registerButton); // Append the form to the container, then add to the document body

container.appendChild(form);
document.body.appendChild(container); // Handle form submission for login

form.addEventListener('submit', function (event) {
  event.preventDefault();
  var username = usernameInput.value;
  var password = passwordInput.value; // Save login data locally (for demonstration purposes)
